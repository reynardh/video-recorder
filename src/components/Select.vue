<template>
    <SelectRoot v-model="selectedOption">
      <SelectTrigger
        class="w-full inline-flex items-center justify-between rounded px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-white text-grass11 shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-green9 outline-none"
...
const selectedOption = defineModel<string>('selected:value');
</script>
