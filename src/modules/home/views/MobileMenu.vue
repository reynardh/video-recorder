    ...
    <div class="absolute right-0 flex w-full justify-end">
        <Menu as="div" class="relative z-10 inline-block text-left">
            ...
            <transition enter-active-class="transition duration-100 ease-out"
                ...
                <MenuItems
                    class="absolute right-0 mt-2 w-[85vw] origin-top-right divide-y divide-gray-100 rounded-md bg-white bg-opacity-10 shadow-lg ring-1 ring-black/5 focus:outline-none">
